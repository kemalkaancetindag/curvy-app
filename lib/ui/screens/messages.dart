                              ...
                              itemBuilder: (context, index) {
                                return GetBuilder<UserOnlineController>(
                                    init: Get.find<UserOnlineController>(
                                        tag: chatController.newMatches![index]
                                                    .user1 ==
                                    ...
                                    builder: (userOnlineController) {
                                      return GestureDetector(
                                        onTap: (){
                                          chatController.startNewChatWithNewMatch(chatController.newMatches![index].chatID!);
                                        },
                                        child: Container(
                                        margin: EdgeInsets.only(
                                            right: Dimensions.w8),
                    ...
                    return GestureDetector(
                      onTap: () {
                        if (chatController.isActiveMessages) {
                          ...
                          chatController.setCurrentChat(
                              chatController.unActiveChats![index].chatID!);
                        }
                      },
                      onPanDown: (details) {
                        if (chatController.isActiveMessages) {
                                                                  ...
                                                                  userOnlineController
                                                                      ...
                                                                      ? Container(
                                                                          ...
                                                                          decoration: BoxDecoration(
                                                                              ...
                                                                              borderRadius: BorderRadius.circular(Dimensions.h7 / 2)),
                                                                        )
                                                                      : Container(),
                                                                  Container(
                                                                    width:
