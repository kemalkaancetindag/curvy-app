                      ...
                      Positioned(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                gradient: LinearGradient(
                                    colors: indexPageController.user != null ? ( indexPageController.user!.sex == 0 ? [Colors.white, Color(0xFFE2C1FC)] : [Colors.white, Color(0xFFABE6FF)]) : [Colors.white, Colors.white],
                                ...
                                RichText(
                                    text: TextSpan(
                                        style: TextStyle(
                                            ...
                                            fontSize: Dimensions.h27 - 3),
                                        text: "Curvy",
                                        children: [TextSpan(text: "PLATINUM")]))
                              ],
                            ),
                          ),
                          Text(
